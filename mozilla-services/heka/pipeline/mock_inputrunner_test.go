...
func (_m *MockInputRunner) Deliver(_param0 *PipelinePack) {
...
func (_m *MockInputRunner) Inject(_param0 *PipelinePack) error {
...
func (_m *MockInputRunner) NewDeliverer(_param0 string) Deliverer {
	ret := _m.ctrl.Call(_m, "NewDeliverer", _param0)
	ret0, _ := ret[0].(Deliverer)
	return ret0
}
...
func (_m *MockInputRunner) NewSplitterRunner(_param0 string) SplitterRunner {
	ret := _m.ctrl.Call(_m, "NewSplitterRunner", _param0)
	ret0, _ := ret[0].(SplitterRunner)
	return ret0
}
...
func (_m *MockInputRunner) Unregister(_param0 *PipelineConfig) error {
