...
func (_m *MockOutputRunner) Encode(_param0 *PipelinePack) ([]byte, error) {
...
func (_m *MockOutputRunner) Encoder() Encoder {
...
func (_m *MockOutputRunner) OldOutput() OldOutput {
	ret := _m.ctrl.Call(_m, "OldOutput")
	ret0, _ := ret[0].(OldOutput)
	return ret0
}
...
func (_m *MockOutputRunner) Unregister(_param0 *PipelineConfig) error {
