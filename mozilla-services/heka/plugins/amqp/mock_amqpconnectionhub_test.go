...
// Source: github.com/mozilla-services/heka/plugins/amqp (interfaces: AMQPConnectionHub)
...
func (_m *MockAMQPConnectionHub) GetChannel(_param0 string, _param1 AMQPDialer) (AMQPChannel, *sync.WaitGroup, *sync.WaitGroup, error) {
	ret := _m.ctrl.Call(_m, "GetChannel", _param0, _param1)
...
func (_mr *_MockAMQPConnectionHubRecorder) GetChannel(arg0, arg1 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "GetChannel", arg0, arg1)
}
