...
/*
#cgo CFLAGS: -std=gnu99 -I /data/servers/BetTest/GolangWork/leafserver/src/github.com/heka/build/heka/include
#cgo LDFLAGS: -Wl,-rpath,$ORIGIN/../lib /data/servers/BetTest/GolangWork/leafserver/src/github.com/heka/build/heka/lib/libluasandbox.so /data/servers/BetTest/GolangWork/leafserver/src/github.com/heka/build/heka/lib/libluasb.so -ldl -lm
#include <stdlib.h>
