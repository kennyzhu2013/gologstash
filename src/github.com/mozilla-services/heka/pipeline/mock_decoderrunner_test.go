...
func (_m *MockDecoderRunner) NewPack() *PipelinePack {
...
func (_m *MockDecoderRunner) Router() MessageRouter {
...
func (_m *MockDecoderRunner) Unregister(_param0 *PipelineConfig) error {
