...
// Source: github.com/mozilla-services/heka/pipeline (interfaces: SplitterRunner)
...
func (_m *MockSplitterRunner) DeliverRecord(_param0 []byte, _param1 Deliverer) {
...
func (_m *MockSplitterRunner) Plugin() Plugin {
...
func (_m *MockSplitterRunner) SetInputRunner(_param0 InputRunner) {
...
func (_m *MockSplitterRunner) SetPackDecorator(_param0 func(*PipelinePack)) {
...
func (_m *MockSplitterRunner) SplitBytes(_param0 []byte, _param1 Deliverer) (int, error) {
...
func (_m *MockSplitterRunner) SplitStream(_param0 io.Reader, _param1 Deliverer) error {
...
func (_m *MockSplitterRunner) SplitStreamNullSplitterToEOF(_param0 io.Reader, _param1 Deliverer) error {
...
func (_m *MockSplitterRunner) Splitter() Splitter {
	ret := _m.ctrl.Call(_m, "Splitter")
	ret0, _ := ret[0].(Splitter)
	return ret0
}
...
func (_m *MockSplitterRunner) Unregister(_param0 *PipelineConfig) error {
